...
public class RegisterTest {
	...
	public void setUp() {
		...
		System.setProperty("webdriver.chrome.driver", "/home/michiel/Documents/Libs/chromedriver");
	...
	public void test_Register_AllFieldsFilledInCorrectly_UserIsRegistered() {
		...
		for (WebElement listItem:listItems) {
				if (listItem.getText().contains("jan.janssens@hotmail.com") &&  listItem.getText().contains("Jan")&&  listItem.getText().contains("Janssens")) {
				    found=true;
			}
		}
		assertTrue(found);
